...
🚨 Be aware, this material is still under contruction and may be missing content 🚨

# REorganized. REpublished. REmastered!

### What is Pathfinder 2 Core SRD REmastered?

This is an adaptation of the **Pathfinder 2 Core SRD** converted to Markdown (.MD) for easy export to other publishing formats and utilized in your own Pathfinder projects. Please report any issues or discrepancies within the material itself; see Discussions & Issues below.
...
Feel free to visit our [discussion](https://github.com/oldmanumby/pf2core.srd/discussions) forum to examine publishing ideas regarding the D&D SRD. Please **REport** any [issues](https://github.com/oldmanumby/pf2core.srd/issues) you find through GitHub. As an alternative, you can **REfork & REuse** this project through a GitHub [pull request](https://github.com/oldmanumby/pf2core.srd/pulls).
